...
void lista1questao03() {
  ...
  char ch;
  printf("Digite três números inteiros separados por vírgula: ");
...
void lista1questao24() {
  float area;
  printf("Digite uma área em metros quadrados: ");
  scanf("%f", &area);
...
void lista1questao28() {
  ...
  char ch;
  printf("Digite três valores separados por vírgula: ");
...
void lista1questao29() {
  ...
  char ch;
  printf("Digite quatro notas separadas por vírgula: ");
...
void lista1questao35() {
  ...
  char ch;
  printf("Digite dois catetos de um triângulo separados por vírgula: ");
...
void lista1questao36() {
  float altura, raio;
  char ch;
  printf("Digite a altura e o raio de um cilindro circular separados por "
         "vírgula: ");
...
void lista1questao42() {
  float salario;
  printf("Digite o valor do salário-base de um funcionário: ");
  scanf("%f", &salario);
...
void lista1questao49() {
  ...
  char ch;
  printf(
      "Digite o horário de início de uma experiência biológica (HH:MM:SS): ");
  scanf("%d%c%d%c%d", &horasInicio, &ch, &minutosInicio, &ch, &segundosInicio);
  printf("Digite a duração em segundos dessa experiência: ");
...
void lista1questao51() {
  ...
  char ch;
  printf("Digite as coordenadas x e y de pontos no R² separadas por vírgula: ");
...
void lista1questao52() {
  ...
  char ch;
  printf("Digite o valor que os três apostadores investiram, separados por "
         "vírgula: ");
...
void lista1questao53() {
  ...
  char ch;
  printf("Digite as dimensões de um terreno (comprimento c e largura l), "
         "separadas por vírgula: ");
  scanf("%f%c%f", &comprimento, &ch, &largura);
  printf("Digite o preço do metro: ");
  scanf("%f", &precoMetro);
